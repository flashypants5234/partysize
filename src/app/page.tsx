...
export default function Home() {
    return (
        <div className="as-skin">
            <a href="#main" className="skip-link">Skip to content
                      </a>
            {}
            ...
            <header
                ...
                <div className="header-inner">
                    ...
                    <Link href="/access" className="btn btn-primary btn-sm">Log In
                                  </Link>
                </div>
            </header>
            {}
            <div className="subnav">
                <div className="container">
                    ...
                    <div className="subnav-actions">
                        <Link href="/claims" className="btn btn-outline btn-sm">Claims
                                        </Link>
                    </div>
                </div>
            </div>
            <main id="main">
                    ...
                    <div className="quote-hero-grid">
                        <div className="quote-hero-left">
                            ...
                            <div className="quote-widget">
                                ...
                                <Link href="/access" className="btn btn-brass btn-block">Start your quote
                                                    </Link>
                ...
                <section
                    ...
                    <div className="container action-tiles">
                        ...
                        <div className="action-tile">
                            ...
                            <div className="action-tile-row">
                                <input type="text" placeholder="ZIP Code" />
                                <Link href="/about#contact" className="btn btn-outline btn-sm">Go
                                                    </Link>
                            </div>
                        </div>
                        <div className="action-tile">
                ...
                <div className="member-banner">
                    <div className="container">
                        ...
                        <Link href="/portal" className="btn btn-outline-light">Policyholder resource guide
                                        </Link>
                    </div>
                </div>
                {}
                            ...
                            <div className="promo-stack">
                                <div className="promo-card">
                                    <div
                                        ...
                                        style={{
                                            background: "linear-gradient(160deg, var(--brass) 0%, var(--navy-950) 140%)"
                                        }}>
                ...
                <section
                    ...
                    <div
                        ...
                        <p>We started Asset Shield because standard insurers were still writing policies for a world of houses and
                                          cars, while a growing share of what people actually hold — crypto, valuables, balances above deposit
                                          limits — sat unprotected.
                                        </p>
                        <p>Today we cover four asset classes with one standard: a real certificate, a claims process you can
                ...
                <div
                    ...
                    <div
                        ...
                        <span>Have business assets to protect?{" "}
                            <Link
                                href="/about#contact"
                                style={{
                                    color: "#fff",
                        ...
                        <div
                            ...
                            <p
                                style={{
                                    color: "#fff",
                                    margin: 0
                                }}>Scan this code with your phone or <a
                                    href="#"
                                    style={{
                                        color: "#fff"
